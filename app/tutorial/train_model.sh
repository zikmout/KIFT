./sphinx_fe -argfile en-us/feat.params -samprate 16000 -c instruction.fileids -di . -do . -ei wav -eo mfc -mswav yes
./bw -hmmdir en-us -moddeffn en-us/mdef.txt -ts2cbfn .cont. -feat 1s_c_d_dd -cmn current -agc none -lda en-us/feature_transform -dictfn cmudict-en-us.dict -ctlfn instruction.fileids -lsnfn instruction.transcription -accumdir .
